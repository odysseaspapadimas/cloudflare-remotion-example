/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f2160a0a3ebfb2b0b4ccd0493e86f4b)
// Runtime types generated with workerd@1.20260317.1 2026-03-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/container");
		durableNamespaces: "RemotionContainer" | "RenderCoordinator";
	}
	interface Env {
		R2_BUCKET: R2Bucket;
		REMOTION_CONTAINER: DurableObjectNamespace<import("./src/container").RemotionContainer>;
		RENDER_COORDINATOR: DurableObjectNamespace<import("./src/container").RenderCoordinator>;
	}
}
